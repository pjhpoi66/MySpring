jQuery( function() { 
    ...
    var ctxPath=location.href.substring(offset,location.href.indexOf('main.hbs',offset+1));
	...
	jQuery(window).resize(function(){
		if( widthSize >= 680){
            ...
            jQuery('#m_menu').css("background","url(/static/assets/image/icons/m_menu.png) no-repeat 0px -4px");      
			
            jQuery('#search-box, #search-box-area').css("visibility","");
            jQuery('#search-box, #search-box-area').css("position","");    
            jQuery('#m_search').css("background","url(/static/assets/image/icons/m_search.png) no-repeat 0px -4px");  
    ...
    jQuery('#m_search').click(function() {
        ...
        if(m_search == 0){
            ...
            jQuery('#m_search').css("background","url(/static/assets/image/icons/m_search.png) no-repeat -31px -3px");    
            m_search = 1;
        }else{
    ...
    jQuery('#m_menu').click(function() {
        ...
        if(m_menu == 0){
            ...
            jQuery('#m_menu').css("background","url(/static/assets/image/icons/m_menu.png) no-repeat -36px -3px");    
